...
#define __ESPUINO_SETTINGS_LOLIN_D32_PRO_H__
    ...
    */
    ...
    // Rotary encoder
        ...
        #define DREHENCODER_DT              34          // 39 = 'VN'; Info: Lolin D32 pro is using 35 for battery-voltage-monitoring!
        #define DREHENCODER_BUTTON          33          // Button 3: is used to switch ESPuino on and off; 36 = 'VP'
    #endif
    ...
    #ifdef MEASURE_BATTERY_VOLTAGE
        uint8_t rdiv1 = 116;                            // Cannot be changed, it's built in
